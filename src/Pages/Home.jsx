                ...
                <div className="col-md-8 mx-auto">
                    ...
                    <Card className="mt-6 card_hover">
                        <CardBody>
                            ...
                            <Typography>
                            Explore six essential Hadith collections, offering valuable insights into the life and teachings of Prophet Muhammad (peace be upon him).
                            </Typography>
                        </CardBody>
                    </Card>
                    </Link>
