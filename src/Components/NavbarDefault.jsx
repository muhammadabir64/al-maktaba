...
import { OLS_SITE, GITHUB_REPO } from "../env";
  ...
  const navList = (
    <ul className="flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className={activePage === 'hadith_books' ? 'p-1 font-normal active_page' : 'p-1 font-normal'}
      >
        <Link to="/hadith-books" className="flex items-center">
          Hadith Books
        </Link>
      </Typography>
      <Typography
      ...
      >
        <Link to={OLS_SITE} className="flex items-center" target="_blank">
          Old Site
        </Link>
      </Typography>
      <Typography
  ...
  return (
    ...
    <Navbar className="mx-auto max-w-screen-xl pt-3 pb-2 px-4 lg:px-8 lg:py-4">
      <div className="container mx-auto flex justify-between text-blue-gray-900">
        ...
        >
          <Link to="/"><i class="fas fa-quran"></i> Al-Maktaba</Link>
        </Typography>
